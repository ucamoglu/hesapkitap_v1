...
class _IncomePlanningScreenState extends State<IncomePlanningScreen> {
  ...
  // Vadesi gelen gelir planlari icin kullanicidan tamamla/ertele/iptal karari alir.
  ...
  String _planSummary(IncomePlan plan) {
  ...
  List<DateTime> _previewDatesForPlan(IncomePlan plan) {
    return PlanningStandard.previewDates(
  ...
  // Gelir planini create/update mantigiyla kaydeder.
    ...
    try {
      ...
      _showSnack(
        shouldExpandRecurring
            ? '${datesToPersist.length} gelir planı kaydedildi.'
            : 'Gelir planı kaydedildi.',
      );
    } catch (e) {
                              ...
                              child: Column(
                                ...
                                children: [
                                  ListTile(
                                    ...
                                    title: Text(
                                        '${_categoryName(p.incomeCategoryId)} • ${_fmtAmount(p.amount)} TL'),
                                    subtitle: Text(
